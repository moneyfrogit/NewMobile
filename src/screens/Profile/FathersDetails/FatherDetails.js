...
const FatherDetails = ({navigation}) => {
    ...
    try {
      ...
      axios
        ...
        .then(dataa => {
          ...
          console.log('Father Profile Overview Data', dataa);
          ...
          setPersonalDetails(dataa.fathers_details);
          console.log('Father Details', personalDetails);
        })
    ...
    <View>
      <List.Accordion
        ...
        <List.Item
          ...
          titleStyle={{color: 'black'}}
          descriptionStyle={{color: 'grey'}}
          description={item.fathers_name}
        />
        {/* <List.Item title="Surname" description={item.surname} /> */}
        <List.Item title="DOB" description={item.father_birthdate} />
        ...
        <List.Item title="PAN No" description={item.father_pancard_no} />
