...
const DashboardInsurance = ({navigation, route}) => {
...

  {
    data &&
      data.map((value, index, array) => {
        annual_premium += parseFloat(value.annual_premium);
        premium_amount += parseFloat(value.premium_amount);
      ...
      <View
        ...
        <View
          ...
          <View
            ...
            <Image
              source={require('../../assets/Images/Networth/ic_insurance.png')}
              style={{
                width: 25,
                height: 25,
