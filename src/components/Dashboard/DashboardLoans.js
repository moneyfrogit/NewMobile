...
const DashboardLoans = ({navigation, route}) => {
    ...
    try {
      ...
      axios
        ...
        .then(data => {
          ...
          //console.log('the Loans data', data);
        })
  ...
  let assets = '';
  let current_outstanding = 0;
  let emi = 0;
  {
    data &&
      data.map((value, index, array) => {
        current_outstanding += parseFloat(value.current_outstanding);
        emi += parseFloat(value.emi);
      });
  }
          ...
          <View
            ...
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              ...
              <Text style={{...FONTS.body3, fontWeight:'bold', color: COLORS.black}}>
                {'\u20B9'} {amountToText(current_outstanding)}
              </Text>
            </View>

            <View style={{justifyContent: 'center', marginRight:20, alignItems: 'center'}}>
              <Text
                style={{
                  ...FONTS.body4,
                  color: COLORS.black,
